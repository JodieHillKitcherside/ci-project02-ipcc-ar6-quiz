var quiz = [
    ...
    },
    {
        ...
        answer: ["Financial, governance, institutional and policy constraints",
    ...
    {
        numb: 4,
        question:"Out of the following, where is the largest gap between projected emissions?",
    ...
    {
        numb: 5,
        question:"The AR6 study on 30,652 species of birds, mammals, reptiles, amphibians, marine fish, benthic marine invertebrates, krill, cephalopods, corals, and seagrasses, concludes a 60-100% predicted risk of species losses at 3-4c for which selection of regions?",
    ...
    },
    {
        ...
        answer: ["Permafrost degradation","Biodiversity loss"],
        options: [
            "Wildfire damage",
    ...
    {
        numb: 10,
        question:"If warming exceeds 1.5c, it could be gradually reduced again by achieving and sustaining negative net zero global CO2 emissions. What is the year by which we must have reduced the 1.5c by 50%, even if we go over this threshold?",
        answer: "2100",
        options: [
            "2080",
            "2090",
    ...
    },
    {
        ...
        options: [
            ...
            "Wind",
            "Bioelectricity",
            "Fossil Carbon Capture and Store"
        ]
    },
    {
        numb: 12,
        ...
        answer: "Ecosystem restoration, afforestation, reforestation",
        options: [
    ...
    },
    {
        ...
        options: [
            ...
            "Enhanced recycling",
            "Material efficiency",
            "Reducing methane from water/waste water",
            "Construction materials substitution"
        ]
    }, 
    {
        numb: 15,
        question: "Where does the highest synergy lie for mitigation and the SDGs?",
